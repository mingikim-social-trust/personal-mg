...
# 규칙 평가 함수
def evaluate_enhanced_rules(data, positive_cases, negative_cases):
    ...
    return recall, precision, enhanced_scores
...
if __name__ == "__main__":
    ...
    recall, precision, results = evaluate_enhanced_rules(data, positive_cases, negative_cases)

    print(f"Enhanced Recall: {recall:.2f}, Enhanced Precision: {precision:.2f}")
    results.to_excel('balance_rule_ver1.1_result.xlsx')